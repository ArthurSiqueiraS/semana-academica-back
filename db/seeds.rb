...
if User.empty?
  User.create(email: 'admin@sam.com', cpf: '000.000.000-00', name: 'Admin', password: '2020', admin: true)
  User.create(email: 'teste@sam.com', cpf: '000.000.000-01', name: 'Teste', password: '2020')
end
